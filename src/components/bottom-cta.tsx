  ...
  return (
    <div className="fixed bg-gray-900 bottom-0 w-full block pointer-events-none">
      <div className="p-2 max-w-3xl mx-auto shadow-lg pointer-events-auto">
        <strong className="font-semibold text-white text-lg ">Find the site helpful?</strong>
        <span className="block sm:inline text-gray-200 md:mx-2">Contribute to the developer, or share it around!</span>
